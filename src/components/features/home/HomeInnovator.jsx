			...
			<div className="mx-auto max-w-6xl">
				<div className="mb-12 text-center">
					...
					<p className="mx-auto max-w-2xl text-lg text-gray-600">
						Kenali tim visioner di balik teknologi revolusioner Racik
					</p>
				</div>
				<div className="rounded-3xl border border-emerald-100 bg-white p-8 shadow-sm md:p-12">
					<div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
						<div>
							...
							<h3 className="mb-4 text-2xl font-bold text-gray-900 md:text-3xl">Tim Racik Innovation</h3>
							<p className="mb-6 leading-relaxed text-gray-600">
								Kami adalah tim multidisiplin yang terdiri dari ahli teknologi, praktisi kesehatan
								tradisional, dan peneliti AI yang berdedikasi untuk menghadirkan inovasi dalam dunia
